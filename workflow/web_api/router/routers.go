...
import (
	...
	"github.com/modentcitizen/easy-workflow/workflow/web_api/docs" // 导入swagger文档用的
	. "github.com/modentcitizen/easy-workflow/workflow/web_api/service"
...
func NewRouter(engine *gin.Engine, ApiBasePath string, ShowSwaggerDoc bool, SwaggerUrl string) *gin.Engine {
	...
	docs.SwaggerInfoeasyworkflow.Description = "https://github.com/modentcitizen/easy-workflow"
