...
### 下载  
方法一:  
在go.mod文件中添加  github.com/modentcitizen/easy-workflow 版本号    

方法二:    
go get github.com/modentcitizen/easy-workflow@版本号  

### 开启引擎  
```go
import "github.com/modentcitizen/easy-workflow/workflow/engine"
